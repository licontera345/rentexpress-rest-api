package com.pinguela.rentexpress.rest.api.vehicle;
...
public class VehicleResource {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "500", description = "Unexpected error while retrieving the vehicle")
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Invalid or incomplete vehicle data supplied"),
                    @ApiResponse(responseCode = "500", description = "Unexpected error while creating the vehicle")
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Invalid vehicle data supplied"),
                    @ApiResponse(responseCode = "404", description = "Vehicle not found"),
                    @ApiResponse(responseCode = "500", description = "Unexpected error while updating the vehicle")
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Vehicle not found"),
                    @ApiResponse(responseCode = "400", description = "Invalid vehicle identifier supplied"),
                    @ApiResponse(responseCode = "500", description = "Unexpected error while deleting the vehicle")
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "204", description = "No vehicles found matching the criteria"),
                    @ApiResponse(responseCode = "400", description = "Invalid search criteria supplied"),
                    @ApiResponse(responseCode = "500", description = "Unexpected error while searching vehicles")
            }
    )
