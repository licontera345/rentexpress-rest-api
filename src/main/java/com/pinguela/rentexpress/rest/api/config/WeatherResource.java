package com.pinguela.rentexpress.rest.api.config;
...
public class WeatherResource {
    ...
    @Operation(
        ...
        description = "Returns current weather data for the specified city. Returns 503 if the external weather service is unavailable.",
        responses = {
            @ApiResponse(
                responseCode = "200",
    ...
    public Response getWeatherByCity(
            ...
            @Parameter(description = "Language code (es, en, fr)") @QueryParam("lang") String lang) throws WeatherApiException {
        try {
            if (city == null || city.trim().isEmpty()) {
                return Response.status(Status.BAD_REQUEST)
                        .entity(new ErrorResponseDTO("BAD_REQUEST", "El parámetro 'city' es obligatorio"))
