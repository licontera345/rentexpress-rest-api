...
@OpenAPIDefinition(info = @Info(title = "Rest API", version = "1.0", description = "demo API", contact = @Contact(name = "API Support", email = "[support@restapi.local](mailto:support@restapi.local)", url = "[https://restapi.local](https://restapi.local)"), license = @License(name = "MIT", url = "[http://localhost:8080/rentexpress-rest-api/swagger-ui/index.html](http://localhost:8080/rentexpress-rest-api/swagger-ui/index.html)")), servers = {
		@Server(url = "[http://localhost:8080/rentexpress-rest-api](http://localhost:8080/rentexpress-rest-api)") })
@ApplicationPath("/api")
