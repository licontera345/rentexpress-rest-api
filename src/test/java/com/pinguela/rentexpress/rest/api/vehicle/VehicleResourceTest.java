...
public class VehicleResourceTest extends JerseyTest {
    ...
    void findByIdReturnsOk() throws Exception {
        ...
        Response response = target("api/vehicle/1").request().get();
    ...
    void createReturnsCreated() throws Exception {
        ...
        Response response = target("api/vehicle").request().post(Entity.json(vehicle));
    ...
    void updateReturnsOk() throws Exception {
        ...
        Response response = target("api/vehicle/3").request().put(Entity.json(vehicle));
    ...
    void deleteReturnsOk() throws Exception {
        ...
        Response response = target("api/vehicle/4").request().delete();
    ...
    void findByCriteriaReturnsOk() throws Exception {
        ...
        Response response = target("api/vehicle/search").queryParam("brand", "test").request().get();
